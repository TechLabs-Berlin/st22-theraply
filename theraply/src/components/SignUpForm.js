...
const SignUpForm = (submitForm) => {
    ...
    return (
        <div className="container">
            <div className="alreadyregistered">Already registered?<a href="#">Sign in</a></div>
            <div className='app-wapper'>
                ...
                <form className='form-wrapper'>
                    <div className='name'>
                        ...
                        <input className='input' type="text" name='fullname' value={values.fulltname}
                            onChange={handleChange} id='fullname' placeholder='Full Name' />
                        {errors.fullname && <p className="error">{errors.fullname}</p>}
                    </div>
                    <div className='email'>
                        <label className='label'>E-Mail</label>
                        <input className='input' type='email' name='email' value={values.email}
                            onChange={handleChange} id='email' placeholder='E-Mail' />
