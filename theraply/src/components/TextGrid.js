    ...
    return <div className='textGrid'>
        ...
        <div className='bodyContainer'>
            ...
            <div className='TBox2'>
                <ul>
                    <li>
                        <span className='TBspan'>Second step:</span>  When you find someone who could be the right fit, call them or write a short email to them and hear if they have time. There are often long waiting lists, with an average of 3 months, and some will not get back to you at all, or they’ll say that they are not taking any new clients. If they have no availability, ask if they can recommend a colleague or continue your search. In case no one can offer you appointments within a reasonable time frame (of approximately a month), jump past step 3-5 and read how to get cost-transfer for psychotherapy from out-of-network practitioners.
                    </li>
                </ul>
            </div>
            <div className='TBox3'>
                <ul>
                    <li>
                        <span className='TBspan'>Third step:</span> when you have found someone with availability soon enough, the first four meetings are the so-called “Probesitzungen”, or trial sessions, where you find out whether you want to continue the process or find a better matching therapist.
                    </li>
                </ul>
                <ul>
                    <li>
                        <span className='TBspan'>Fourth step:</span> When you then agree to continue the process, the psychotherapist will write an application to your health insurance company, which then grants a certain number of times. Once the application has been processed after a few weeks, the therapy can be continued.
                    </li>
                </ul>
            </div>
            <div className='bodyImage'>
